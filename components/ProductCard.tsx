  ...
  return (
    ...
    >
      <Link href={`/productos/${sneaker.id}`} className="block">
        {/* Usar borde simple en lugar de ElectricBorder */}
        <div className="border-2 border-white/10 hover:border-cyan-400/50 rounded-lg transition-all bg-gradient-to-br from-black/80 to-gray-900/60 backdrop-blur-sm overflow-hidden group">
          {/* Product Image */}
